...
const (
	finalizerString = "finalizers.networkfirewall.services.k8s.aws/RuleGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("rulegroups")
