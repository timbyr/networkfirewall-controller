...
// +kubebuilder:rbac:groups=networkfirewall.services.k8s.aws,resources=firewalls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkfirewall.services.k8s.aws,resources=firewalls/status,verbs=get;update;patch
