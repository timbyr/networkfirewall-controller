...
const (
	finalizerString = "finalizers.networkfirewall.services.k8s.aws/Firewall"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("firewalls")
