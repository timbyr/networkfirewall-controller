...
// +kubebuilder:rbac:groups=networkfirewall.services.k8s.aws,resources=firewallpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=networkfirewall.services.k8s.aws,resources=firewallpolicies/status,verbs=get;update;patch
...
type resourceManager struct {
	...
	sdkapi svcsdkapi.NetworkFirewallAPI
}
