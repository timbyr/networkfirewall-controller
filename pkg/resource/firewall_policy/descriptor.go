...
const (
	finalizerString = "finalizers.networkfirewall.services.k8s.aws/FirewallPolicy"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("firewallpolicies")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.FirewallPolicy{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.FirewallPolicy),
	}
}
